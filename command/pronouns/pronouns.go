...
func add(p *sb.Params) string {
	...
	if !isPronoun.MatchString(pronounSet) {
		return "Invalid pronoun format. Please use a-z, spaces, and forward slashes, e.g. `/pronoun add they/them`. Remember, you don't have to add them all in one command — you can add multiple sets."
	}
